...
get_occupation <- function(legislature) {
  ...
  ghurl <- base::paste0("https://github.com/saschagobel/legislatoR/blob/master/data-raw/", legislature, "_occupation?raw=true")
