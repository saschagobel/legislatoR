#' Legislators Wikipedia edit data.
#'
#' Fetches full revision histories of legislators' Wikipedia biographies for the specified legislature from the GitHub repository. Requires a working Internet connection.
#'
...
get_history <- function(legislature) {
  ...
  ghurl <- base::paste0("https://github.com/saschagobel/legislatoR-data/blob/master/data/", legislature, "_history?raw=true")
